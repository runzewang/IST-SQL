...
def train_epoch_with_interactions(interaction_batches,
    ...
    for i, interaction_batch in enumerate(interaction_batches):
        ...
        if interaction.identifier == "raw/atis2/12-1.1/ATIS2/TEXT/TEST/NOV92/770/5":
        	continue
        # if 'cosql' in params.data_directory and "baseball_1/18" in interaction.identifier:
        # 	continue
        # if 'cosql' in params.data_directory and "baseball_1/13" in interaction.identifier:
        # 	continue
        # if 'sparc' in params.data_directory and "baseball_1" in interaction.identifier:
        # 	continue
        # if 'sparc' in params.data_directory and "soccer_1" in interaction.identifier:
        # 	continue

        if 'cosql' in params.data_directory and "baseball_1" in interaction.identifier:
            ingore_interaction += 1
            print('ingore_interaction: ', ingore_interaction)
            continue
        if 'sparc' in params.data_directory and "baseball_1" in interaction.identifier:
            ingore_interaction += 1
            print('ingore_interaction: ', ingore_interaction)
            continue
        # if 'cosql' in params.data_directory and "formula_1" in interaction.identifier:
        #     ingore_interaction += 1
        #     print('ingore_interaction: ', ingore_interaction)
        #     continue
        ...
        try:
            ...
            if "out of memory" in str(exception):
                print('interaction.identifier', interaction.identifier)
                # ingore_interaction += 1
                # print('ingore_interaction: ', ingore_interaction)
                # continue
                raise exception
        ...
        if (i+1) % 80 == 0 or (i+1) == len(interaction_batches):
            progbar.update(i)
