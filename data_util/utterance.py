...
class Utterance:
    ...
    def process_gold_seq(self,
        ...
        if anonymize:
            print('use anonymizer for output')
            ...
            print('not use anonymizer for output')
    ...
    def length_valid(self, input_limit, output_limit):
        # if len(self.gold_query_to_use) > output_limit:
        #     print('self.input_seq_to_use', self.input_seq_to_use)
        #     print('self.gold_query_to_use', self.gold_query_to_use)
