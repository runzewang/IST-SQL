...
def interpret_args():
    ...
    parser.add_argument('--use_utterance_mulrel', type=bool, default=True)
    parser.add_argument('--use_utterance_schema_mulrel', type=bool, default=True)
    #utterance update
    parser.add_argument('--utterance_mulrel_series', type=bool, default=False)
    parser.add_argument('--use_utterance_after_schema', type=bool, default=False)
    #schema update
    parser.add_argument('--use_query_utterance_schema_mulrel', type=bool, default=False)
    parser.add_argument('--use_query_utterance_schema_mulrel_mlp', type=bool, default=False)
    parser.add_argument('--use_query_update_schema_mulrel', type=bool, default=False)
    parser.add_argument('--use_query_update_schema_mulrel_mlp', type=bool, default=False)
    parser.add_argument('--use_utterance_update_schema_mulrel', type=bool, default=False)
    parser.add_argument('--use_utterance_update_schema_mulrel_mlp', type=bool, default=False)
    #decoder
    parser.add_argument('--copy_switch_query', type=bool, default=False)
    parser.add_argument('--norm_loss', type=bool, default=False)
    #trainer
    parser.add_argument('--clip_lr', type=bool, default=False)
    # gcn
    parser.add_argument('--gcn_edge_type', type=str, default="edge2",  help='edge1, edge2')
    parser.add_argument('--column_label_type', type=str, default="cross",  help='binary, sql, semql, cross')
    parser.add_argument('--dst_loss_weight', type=float, default=0.,  help='between 0-1')
    parser.add_argument('--get_seq_from_scores_flatten', type=bool, default=False,  help='use flatten score or not when compute validation score')
    parser.add_argument('--new_loss', type=bool, default=False,  help='use new loss')
    parser.add_argument('--use_previous_emb_for_previous_query', type=bool, default=False,  help='use previous emb for previous query')
    parser.add_argument('--use_current_emb_dynamic', type=bool, default=False,  help='use current emb dynamic')
